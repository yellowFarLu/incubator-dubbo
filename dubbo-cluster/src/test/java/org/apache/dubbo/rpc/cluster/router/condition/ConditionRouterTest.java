...
public class ConditionRouterTest {
    ...
    public void testRoute_matchWhen() {
        ...
        Router router = new ConditionRouterFactory().getRouter(getRouteUrl("host = 2.2.2.2 & host != 1.1.1.1 & method = hello"));
        ...
        router = new ConditionRouterFactory().getRouter(getRouteUrl(" => host = 1.2.3.4"));
